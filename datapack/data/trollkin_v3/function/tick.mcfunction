...
#debug:
execute as @a[tag=trollkin_v3.debug] run function trollkin_v3:fetchr/tick/player_tick
execute as @a[tag=trollkin_v3.debug] run function trollkin_v3:fetchr/tick/game/player_tick
execute if entity @a[tag=trollkin_v3.debug] run function trollkin_v3:fetchr/tick/game/tick
