...
execute if score @s trollkin_v3.dev matches 5 run item replace entity @a armor.head with minecraft:firework_star[minecraft:rarity="rare",minecraft:lore=[{"translate":"enchantment.minecraft.binding_curse",color:"red",italic:false}],minecraft:enchantment_glint_override=true,minecraft:item_name={translate:"block.minecraft.carved_pumpkin"},minecraft:item_model="minecraft:carved_pumpkin",minecraft:equippable={slot:"head",camera_overlay:"misc/pumpkinblur"}]
